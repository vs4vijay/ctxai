...
class PluginInterface(ABC):
    ...
    def on_tool_call(self, tool_name: str, args: dict[str, Any], context: PluginContext) -> dict[str, Any]:
        """Called before a tool is executed. Return possibly-modified args."""
        return args

    def on_tool_result(self, tool_name: str, result: dict[str, Any], context: PluginContext) -> dict[str, Any]:
        """Called after a tool finishes. Return possibly-modified result."""
        return result

    # ----- Provider hooks -----

    def on_llm_request(self, messages: list[Any], context: PluginContext) -> list[Any]:
